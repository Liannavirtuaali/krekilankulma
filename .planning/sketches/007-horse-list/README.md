# 007 — Horse List Design

**Designkysymys:** Miten hevosten lista esitetään admin-hallinnassa? Mikä tapa tukee parhaiten selailua, muokkaamista ja poistamista?

**Variantit:**
- **A: Moderni taulukko** — Klassinen taulukko uusittuna: pyöristetty, lajiteltavat sarakkeet, hover-piilotetut toiminnot, gender-badget väreillä.
