...
<body>
	...
	<div id="header"><h1 class="inset-text">Hiienhelmi</h1></div>
...
<p class="tiedot">Kutsumanimeltään <u>Hissu</u><br>
Voikko <span class="pikkuinfo">(ee/aa/nCr)</span> suomenhevonen tamma, 146cm <br>
Syntynyt 14.05.2020, on nyt 10-vuotias <br>
<a href="http://www.virtuaalihevoset.net/virtuaalihevoset/hevonen/VH26-018-0286">VH26-018-0286</a>, <a href="https://piirroshevosille.fi/hevoset/hevonen/PKK">PKK</a>
</p>
<p class="tiedot">
Kasvattanut Hanna Haapala <img src="https://lianna.altervista.org/flag/fi.png"> <br>
Omistaa <a href="">Ramona Reyes</a> / <a href="">Krekilänkulma</a> <span class="pikkuinfo">(VRL-05175, <a href="mailto:liannavirtuaali@gmail.com">&#9993;</a>)</span>
</p>
<p class="tiedot">
Yleispainotteinen <br>
ko: Vaativa B, re: 110cm, CIC1
</p>
<p class="tiedot">
...
<p>Hissu on kiltti ja hyväkäytöksinen tamma, joka nauttii ihmisten seurasta ja huomiosta. Se tulee mielellään vastaan tarhassa ja suhtautuu uusiin ihmisiin uteliaasti mutta rauhallisesti. Hoitotilanteissa Hissu seisoo yleensä nätisti paikallaan ja antaa tehdä tarvittavat toimenpiteet ilman turhaa hötkyilyä. Tammamaisuutta löytyy sopivasti, ja toisinaan Hissu osaa ilmaista mielipiteensä ilmeillä tai korvien asennolla, mutta pohjimmiltaan se on yhteistyöhaluinen ja luotettava käsitellä. </p>

<p>Ratsastaessa Hissu on herkkä mutta rauhallinen. Se kuuntelee ratsastajan apuja tarkasti ja pyrkii aina tekemään parhaansa tilanteessa kuin tilanteessa. Hissu liikkuu eteenpäin omalla moottorillaan, mutta säilyttää samalla miellyttävän rauhallisen luonteen. Se palkitsee tasaisen ja selkeän ratsastuksen pehmeällä tuntumalla sekä mukavalla työskentelyhalulla. Hissu sopii monentasoisille ratsastajille, sillä se on anteeksiantavainen, mutta opettaa samalla ratsastajalleen tarkkuutta ja oikea-aikaisia apuja. </p>

<ul><p>Esteillä Hissu innostuu selvästi. Se lähestyy esteitä rohkeasti eikä turhia kyttäile erikoisempiakaan virityksiä. Tamma yrittää aina parhaansa mukaan auttaa ratsastajaansa onnistumaan ja korjaa tarvittaessa pieniäkin lähestymisvirheitä. Innostuksestaan huolimatta Hissu pysyy hyvin hallinnassa ja säilyttää järkevän päänsä myös vauhdikkaammissa tehtävissä. </p>

<p>Maastossa Hissu on varma ja luotettava ratsu. Se kulkee niin yksin kuin seurassakin rennosti ja suhtautuu uusiin reitteihin rohkeasti. Hissu ei säiky turhia, vaan tutkii epäilyttävät asiat mieluummin uteliaasti kuin pakenee niitä. Maastoretket ovat Hissulle mieluista vaihtelua, ja sen kanssa on mukava nauttia niin rauhallisista kävelylenkeistä kuin vauhdikkaammistakin laukkapätkistä. </p></ul>

<p>Kilpailupaikoilla Hissu käyttäytyy fiksusti ja rauhallisesti. Uusi ympäristö tai tapahtumien vilinä eivät sitä helposti hetkauta, vaan se keskittyy tehtäväänsä ja luottaa ratsastajaansa. Hissu matkustaa hyvin, sopeutuu uusiin paikkoihin nopeasti ja esiintyy edukseen niin verryttelyssä kuin radallakin. Sen rauhallisuus tekee siitä miellyttävän matkakumppanin, jonka kanssa on helppo lähteä uusiin haasteisiin. </p>
