...
$f = [
    ...
    'level_ko' => '', 'level_re' => '', 'owner_name' => '', 'owner_email' => '',
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!validate_csrf_token($_POST['csrf_token'] ?? '')) {
        ...
        if (empty($errors)) {
            ...
            $stmt = $db->prepare(
                'INSERT INTO horses
                 (name, call_name, vh_id, breed_id, birth_date, aging_system, gender, color_id, genes, height_cm,
                  level_ko, level_re, owner_name, owner_email, breeder_name, breeder_email,
